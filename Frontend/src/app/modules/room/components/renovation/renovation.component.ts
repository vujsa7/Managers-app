...
import { Room, RoomStatus, RoomType } from '@app/shared/models/room.model';
...
export class RenovationComponent implements OnInit {
  ...
  constructor(private roomService: RoomService, private route: ActivatedRoute, private router: Router, private d3Service: D3Service, private renovationService: RenovationService) { }
    ...
    this.route.params.subscribe(params => {
      ...
      this.roomService.getRoom(roomId).subscribe(
        data => {
          ...
          this.roomService.getRooms(this.room.buildingId).subscribe(
            data => {
